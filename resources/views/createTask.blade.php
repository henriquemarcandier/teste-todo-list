...
<form method="POST" action="{{route('storeTask', $idToDo)}}" id="formRegisterTask">
    ...
    <label for="date">Data: </label><input type="date" class="form-control" name="date" id="date" required placeholder="Informe a data do To Do aqui corretamente..." value="{{date('Y-m-d')}}"><br>
